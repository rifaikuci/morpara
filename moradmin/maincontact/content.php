...
$sql = "SELECT * FROM tblmaincontact WHERE id = '1'";
...
if ($_GET['durumekle'] == "ok") {
    durumSuccess("Contact Başarılı Bir Şekilde Eklendi. ");
} else if ($_GET['durumekle'] == "no") {
    durumDanger("Contact Eklenirken Bir Hata Oluştu !");
} else if ($_GET['durumsil'] == "ok") {
    durumSuccess("Contact Başarılı Bir Şekilde Silindi. ");
} else if ($_GET['durumsil'] == "no") {
    durumDanger("Contact Silinirken Bir Hata Oluştu.");
} else if ($_GET['durumguncelleme'] == "ok") {
    durumSuccess("Contact Page Başarılı Bir Şekilde Güncellendi. ");
} else if ($_GET['durumguncelleme'] == "no") {
    durumDanger("Contact  Page Güncellenirken Bir Hata Oluştu.");
} ?>

<form method="post" action="../netting/maincontact.php" enctype="multipart/form-data">
    <div class="card">
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="maincontactguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>
            <a href="<?php echo base_url() . "maincontact" ?>"

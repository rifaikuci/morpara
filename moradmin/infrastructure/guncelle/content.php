...
if ($_GET['id']) {
    ...
    $sql = "SELECT * FROM tblinfrastructure WHERE id = '$id'";
    $result = mysqli_query($db, $sql);
    $row = $result->fetch_assoc();
} ?>

<form method="post" action="../../netting/infrastructure.php" enctype="multipart/form-data">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Alt Yapı Alt Açıklama</label>
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="infrastructureguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>

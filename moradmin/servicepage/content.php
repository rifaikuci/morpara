...
$sql = "SELECT * FROM tblservicepage WHERE id = '1'";
...
if ($_GET['durumekle'] == "ok") {
    durumSuccess("Service Başarılı Bir Şekilde Eklendi. ");
} else if ($_GET['durumekle'] == "no") {
    durumDanger("Service Eklenirken Bir Hata Oluştu !");
} else if ($_GET['durumsil'] == "ok") {
    durumSuccess("Service Başarılı Bir Şekilde Silindi. ");
} else if ($_GET['durumsil'] == "no") {
    durumDanger("Service Silinirken Bir Hata Oluştu.");
} else if ($_GET['durumguncelleme'] == "ok") {
    durumSuccess("Service Page Başarılı Bir Şekilde Güncellendi. ");
} else if ($_GET['durumguncelleme'] == "no") {
    durumDanger("Service  Page Güncellenirken Bir Hata Oluştu.");
} ?>

<form method="post" action="../netting/servicepage.php" enctype="multipart/form-data">
    <div class="card">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        <label>Service Başlık</label>
                        <input type="text" class="form-control form-control-lg" name="title"
                               value="<?php echo $row['title'] ?>"
                               placeholder="Service Başlık Giriniz...">
                    </div>
                </div>

                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Service Alt Başlık</label>
                        <input type="text" class="form-control form-control-lg" name="subTitle"
                               value="<?php echo $row['subTitle'] ?>"
                               placeholder="Service Alt Başlık Giriniz...">
                    </div>
                </div>

                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Service Link (Read More için)</label>
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="servicepageguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>
            <a href="<?php echo base_url() . "servicepage" ?>"

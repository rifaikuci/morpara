...
$sql = "SELECT * FROM tblfooter WHERE id = '1'";
...
if ($_GET['durumekle'] == "ok") {
    durumSuccess("Footer Başarılı Bir Şekilde Eklendi. ");
} else if ($_GET['durumekle'] == "no") {
    durumDanger("Footer Eklenirken Bir Hata Oluştu !");
} else if ($_GET['durumsil'] == "ok") {
    durumSuccess("Footer Başarılı Bir Şekilde Silindi. ");
} else if ($_GET['durumsil'] == "no") {
    durumDanger("Footer Silinirken Bir Hata Oluştu.");
} else if ($_GET['durumguncelleme'] == "ok") {
    durumSuccess("Footer Page Başarılı Bir Şekilde Güncellendi. ");
} else if ($_GET['durumguncelleme'] == "no") {
    durumDanger("Footer  Page Güncellenirken Bir Hata Oluştu.");
} ?>

<form method="post" action="../netting/footer.php" enctype="multipart/form-data">
    <div class="card">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        <label>Footer Başlık</label>
                        <input type="text" class="form-control form-control-lg" name="title"
                               value="<?php echo $row['title'] ?>"
                               placeholder="Footer Başlık Giriniz...">
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="footerguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>

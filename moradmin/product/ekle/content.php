...
<section class="content">
    ...
    <form method="post" action="../../netting/product.php" enctype="multipart/form-data">
        <div class="card">
        ...
        <div class="card-footer">
            <div>
                <button type="submit" name="productekleme" class="btn btn-info float-right">Ekle</button>

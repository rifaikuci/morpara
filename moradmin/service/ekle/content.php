...
<section class="content">
    ...
    <form method="post" action="../../netting/service.php" enctype="multipart/form-data">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Service Alt Açıklama</label>
        ...
        <div class="card-footer">
            <div>
                <button type="submit" name="serviceekleme" class="btn btn-info float-right">Ekle</button>

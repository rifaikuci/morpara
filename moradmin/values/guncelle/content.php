...
if ($_GET['id']) {
    ...
    $sql = "SELECT * FROM tblvalues WHERE id = '$id'";
    $result = mysqli_query($db, $sql);
    $row = $result->fetch_assoc();
} ?>

<form method="post" action="../../netting/values.php" enctype="multipart/form-data">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Values Alt Açıklama</label>
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="valuesguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>
            <a href="<?php echo base_url() . "values" ?>"

...
<div class="content">
    ...
    if ($_GET['durumekle'] == "ok") {
        ...
        durumSuccess("Değerimiz Başarılı Bir Şekilde Güncellendi. ");
    } else if ($_GET['durumguncelleme'] == "no") {
        durumDanger("Değerimiz Güncellenirken Bir Hata Oluştu.");
    } ?>
                            ...
                            while ($row = $result->fetch_array()) { ?>
                                <tr>
                                    ...
                                    <td><a href=<?php echo "guncelle/?id=" . $row['id']; ?> class="btn
                                        ...
                                        <a href=<?php echo base_url() . "netting/values.php?valuessil=" . $row['id']; ?> class="btn
                                           btn-danger">Sil</a>
                                    </td>
                                </tr>
                                <?php $sira++;

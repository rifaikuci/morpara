...
$sql = "SELECT * FROM tblsolutionpage WHERE id = '1'";
...
if ($_GET['durumekle'] == "ok") {
    durumSuccess("Solution Başarılı Bir Şekilde Eklendi. ");
} else if ($_GET['durumekle'] == "no") {
    durumDanger("Solution Eklenirken Bir Hata Oluştu !");
} else if ($_GET['durumsil'] == "ok") {
    durumSuccess("Solution Başarılı Bir Şekilde Silindi. ");
} else if ($_GET['durumsil'] == "no") {
    durumDanger("Solution Silinirken Bir Hata Oluştu.");
} else if ($_GET['durumguncelleme'] == "ok") {
    durumSuccess("Solution Page Başarılı Bir Şekilde Güncellendi. ");
} else if ($_GET['durumguncelleme'] == "no") {
    durumDanger("Solution  Page Güncellenirken Bir Hata Oluştu.");
} ?>

<form method="post" action="../netting/solutionpage.php" enctype="multipart/form-data">
    <div class="card">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        <label>Solution Başlık</label>
                        <input type="text" class="form-control form-control-lg" name="title"
                               value="<?php echo $row['title'] ?>"
                               placeholder="Solution Başlık Giriniz...">
                    </div>
                </div>

                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Solution Alt Başlık</label>
                        <input type="text" class="form-control form-control-lg" name="subTitle"
                               value="<?php echo $row['subTitle'] ?>"
                               placeholder="Solution Alt Başlık Giriniz...">
                    </div>
                </div>

                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Solution Link (Read More için)</label>
    ...
    <div class="card-footer">
        <div>
            <button type="submit" name="solutionpageguncelleme" class="btn btn-info float-right">
                Güncelle
            </button>
            <a href="<?php echo base_url() . "solutionpage" ?>"

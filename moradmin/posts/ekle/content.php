...
<section class="content">
    ...
    <form method="post" action="../../netting/posts.php" enctype="multipart/form-data">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Duyuru Alt Açıklama</label>
        ...
        <div class="card-footer">
            <div>
                <button type="submit" name="postsekleme" class="btn btn-info float-right">Ekle</button>
